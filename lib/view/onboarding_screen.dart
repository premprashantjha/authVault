...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  static const List<OnboardingSlide> _slides = [
    OnboardingSlide(
      ...
      description:
          'All your accounts are encrypted and stored securely on your device only.',
      icon: Icons.security,
      tips: [
    ...
    OnboardingSlide(
      ...
      description:
          'Your device lock (PIN/pattern/biometric) protects access to the app.',
    ...
    OnboardingSlide(
      ...
      description:
          'Create encrypted backups to protect against device loss or damage.',
      icon: Icons.backup,
      tips: [
    ...
    OnboardingSlide(
      ...
      description:
          'Your authenticator is ready to use. Add accounts and stay secure.',
                ...
                itemBuilder: (context, index) {
                  ...
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(
                          height: AppConstants.getResponsiveSpacing(context),
                        ),
                        Container(
                          ...
                          width: AppConstants.getResponsiveIconSize(
                            context,
                            small: 64.0,
                            medium: 72.0,
                            large: 80.0,
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(
                              AppConstants.getResponsiveRadius(
                                context,
                                large: 24.0,
                              ),
                            ),
